...
t0 = time.time()
rgbanddest = pyd.Destretch(rosa_gband_1, rosa_gband_0, [0, 64, 32, 16], ncores=4)
destrgband = rgbanddest.perform_destretch()
print(time.time() - t0, "seconds to destretch 1k image relative to previous iteration")
...
ax.imshow(rosa_4170_1/np.nanmean(rosa_4170_1) - destr4170/np.nanmean(destr4170), vmin=-0.1, vmax=0.1)
